...
import ir.ac.um.melogger.analysis.uninstrument.UnInstrumenter;
 ...
 * @author Samad Paydar
 */
public class UnInstrumentAction extends AnAction {
    ...
    private void processProject(Project project, PsiElement psiElement) {
        ...
        ApplicationManager.getApplication().executeOnPooledThread(new Runnable() {
            public void run() {
                ApplicationManager.getApplication().runReadAction(new UnInstrumenter(project, psiElement));
            }
        });
